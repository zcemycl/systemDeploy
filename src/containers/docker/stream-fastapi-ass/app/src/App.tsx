...
import Route09GraphqlInterrupt from './components/Route09GraphqlInterrupt'
...
function App() {
  ...
  const cards = [
    ...
    {
      key: 'route-09',
      label: '09 GraphQL + LangGraph Interrupt',
      content: <Route09GraphqlInterrupt apiBaseUrl={apiBaseUrl} />,
    },
  ]
